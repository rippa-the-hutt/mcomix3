...
class _BookArea(Gtk.ScrolledWindow):
    ...
    def __init__(self, library):
        ...
        actiongroup.add_radio_actions([
            ('ascending', "Sort Ascending", _('Ascending'), None, None,
                constants.SORT_ASCENDING),
            ('descending', "Sort Descending", _('Descending'), None, None,
    ...
    def _get_pixbuf(self, uid):
        ...
        if self._cache.exists(book.path):
            ...
            pixbuf = self._library.backend.get_book_thumbnail(book.path) or image_tools.get_missing_pixbuf()
        ...
        book_pixbuf = self.render_icon("Apply", Gtk.IconSize.LARGE_TOOLBAR)
    ...
    def _drag_begin(self, iconview, context):
        ...
        if cover is None:
            cover = image_tools.get_missing_pixbuf()
