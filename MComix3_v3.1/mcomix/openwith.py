...
class OpenWithEditor(Gtk.Dialog):
    ...
    def _layout(self):
        ...
        content.pack_start(scroll_window, False, True, 0)

        buttonbox = Gtk.HBox()
        buttonbox.pack_start(self._add_button, False, True, 0)
        buttonbox.pack_start(self._add_sep_button, False, True, 0)
        buttonbox.pack_start(self._remove_button, False, True, 0)
        buttonbox.pack_start(self._up_button, False, True, 0)
        buttonbox.pack_start(self._down_button, False, True, 0)
        content.pack_start(buttonbox, False, True, 0)

        preview_box = Gtk.HBox()
        preview_box.pack_start(Gtk.Label(_('Preview:')), False, True, 0)
        preview_box.pack_start(self._test_field, padding=4)
        preview_box.pack_start(self._run_button, False, True, 0)
        content.pack_start(preview_box, False, True, 0)

        content.pack_start(self._exec_label, False, True, 0)
