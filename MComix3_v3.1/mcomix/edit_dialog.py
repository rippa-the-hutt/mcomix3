...
class _EditArchiveDialog(Gtk.Dialog):
    ...
    def __init__(self, window):
        ...
        self._accept_changes_button = self.add_button("Apply", Gtk.ResponseType.APPLY)
        ...
        self._save_button = self.add_button("Save As", constants.RESPONSE_SAVE_AS)

        self._import_button = self.add_button(_('_Import'), constants.RESPONSE_IMPORT)
        self._import_button.set_image(Gtk.Image.new_from_icon_name("Add",
            Gtk.IconSize.BUTTON))
    ...
    def _load_original_files(self):
        ...
        self._window.set_cursor(Gdk.Cursor.new_for_display(Gdk.Display.get_default(), Gdk.CursorType.WATCH))
