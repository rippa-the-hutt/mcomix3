...
class MainUI(Gtk.UIManager):
    ...
    def __init__(self, window):
        ...
        self._actiongroup.add_actions([
            ...
            ('extract_page', "Save As", _('Save _As'),
                None, None, window.extract_page),
            ('menu_zoom', 'mcomix-zoom', _('_Zoom')),
            ('menu_recent', "Multiple", _('_Recent')),
            ...
            ('menu_open_with', "Open", _('Open _with'), ''),
            ('menu_open_with_popup', "Open", _('Open _with'), ''),
            ('menu_file', None, _('_File')),
            ('menu_view', None, _('_View')),
            ('menu_view_popup', 'comix-image', _('_View')),
            ('menu_go', None, _('_Go')),
            ('menu_go_popup', "Forward", _('_Go')),
        ...
        self._actiongroup.add_toggle_actions([
            ('fullscreen', "Fullscreen", _('_Fullscreen'),
            ...
            ('invert_scroll', "Undo", _('Invert smart scroll'),
            ...
            ('slideshow', "Play", _('Start _slideshow'),
