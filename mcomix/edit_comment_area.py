...
class _CommentArea(Gtk.VBox):
    ...
    def __init__(self, edit_dialog):
        ...
        info = Gtk.Label(_('Please note that the only files that are automatically added to this list are those files in archives that MComix3 recognizes as comments.'))
